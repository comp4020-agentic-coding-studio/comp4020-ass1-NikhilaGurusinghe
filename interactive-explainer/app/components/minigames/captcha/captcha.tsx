          ...
          <div className="bg-(--background-secondary) border shadow-md/20 rounded-md border-gray-400 flex w-full max-w-3xl max-h-[90vh] flex-col items-center py-12 px-8 sm:items-start">
            ...
            <div className="w-full min-h-0 overflow-y-auto flex flex-col items-center sm:items-start mb-4">
              <span className="border-l-2 pl-2 ml-2 my-3">
                <p>
                  “[Google's Captcha] asks the user to identify images of
                  crosswalks, street lights, and other objects. It has been
                  hypothesized that the data is used by Waymo, a Google
                  subsidiary, to train autonomous vehicles, though an unnamed
                  representative has denied this, claiming the data was only
                  being used to improve Google Maps as of mid-2021.”
                </p>
                <br></br>
                <a
              ...
              <span className="border-l-2 pl-2 ml-2 my-3">
                <p>
                  “This kind of invisible, hidden labor, outsourced or
                  crowdsourced, hidden behind interfaces and camouflaged within
                  algorithmic processes is now commonplace, particularly in the
                  process of tagging and labeling thousands of hours of digital
                  archives for the sake of feeding the neural networks.
                  Sometimes this labor is entirely unpaid, as in the case of the
                  Google’s reCAPTCHA. In a paradox that many of us have
                  experienced, in order to prove that you are not artificial
                  agent, you are forced to train Google’s image recognition AI
                  system for free, by selecting multiple boxes that contain
                  street numbers, or cars, or houses.
                </p>

                <p>
                  As we see repeated throughout the system, contemporary forms
                  of artificial intelligence are not so artificial after all”
                </p>
                <br></br>
                <a
                  className="font-bold italic underline"
                  href="https://anatomyof.ai/"
                >
              ...
              <ul className="list-disc ml-5 mb-4">
                <li>
                  Use your mouse to click the images that contain the object
                  stated at the top of the next page.
                </li>
                <li>
                  You can unselect a box by pressing it again, after it is
                  selected.
                </li>
                <li>
                  If none of the objects stated at the top of the page are in
                  any of the images, then just press the next button and select
                  no boxes.
                </li>
